...
## 🟢 PLAY — M7 `--aicontrol`: **implementation ACTIVE — C1 shared substrate ✅ (J-201)**; **next-active = Joe-lock checkpoint #1 before C2** (pipe/codec/dispatch-arm wiring + ratify substrate home + the D-078 timeout-constant finding)

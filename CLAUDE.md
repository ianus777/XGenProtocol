...
## 🟢 PLAY — M6 (new): **node-policy arc OPENED — audit + design (NP-D1–D6) LOCKED + impl runbook authored (J-196, doc-only)**; **next-active = Clair C1** (store + 2 verbs + threading, no checkpoint) → C2 close → then M7 `--aicontrol`

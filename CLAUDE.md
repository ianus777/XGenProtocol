...
> Date: May 2026  
> **Status:** ACTIVE  
> **Last updated:** 2026-05-20 (XGID Adoption v1 Phase 2 doc-tree sweep CLOSED; classification table at `tasks/XGID_DOC_SWEEP.md` (Status: COMPLETED v1.2) covers 23 in-scope docs with Scope-B lock applied uniformly; verdict distribution: 4 v1-already-shipped + 1 v1-follow-on-pointer (Ch4) + 2 Pass-1 docs (Appx C, Appx I) + 1 Pass-3 doc (Appx D) + 1 Pass-5 doc (Appx G) + 14 no-update; pre-walk housekeeping flipped the two SK appendix translations to DEPRECATED; observations recorded for future Retrofit Pass runbook authors. Phase 2 deliverable is classification table; per-doc edits land afterwards under each Retrofit Pass. Phase 1 canonical sources remain shipped; Clair's two-commit implementation runbook remains ready for independent pickup. Phase 9 stays PAUSED at Commit 3 boundary; XGID Adoption v1 milestone closes when Clair's two-commit implementation ships, and Phase 9 resumes after.)  
> Author: JozefN  

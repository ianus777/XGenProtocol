...
**Leg B — the render rules.** ✅ **UNBLOCKED — Leg A landed the ids (J-647).** 🔒 **Runbook `tasks/RUNBOOK_IDENTITY_RESOLUTION_LEG_B.md` v1.0 — AUTHORED, NOT LOCKED (J-650). Nobody is implementing it.**

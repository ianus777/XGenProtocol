...
**Caught by Phase 9 set:** 12 of 15 (M15 caught by Scenario 1 second `#[ignore]` lift at topological-sort milestone J-101 — the same scenario that surfaced the determinism finding at J-096 became the activating regression lock for both layers).

...
│   │   ↳ trigger: **M-INTRO-POLICY Q11 is ruled** — the DM-privacy D cannot be stated as a guarantee until the recipient has BOTH a cut and a ban; **the two are INDEPENDENT EVENTS (Joe, J-740) — a DM can be cut without any subsequent ban, and a ban needs no prior DM at all — so this milestone SPLITS INTO TWO LEGS that ship in either order and either may discharge its half alone.** The J-739 wording said *a cut and a ban* and read as one indivisible prerequisite; the ban half is Space-independent by nature and therefore sits closer to M-RP-PEOPLE than to the DM arc

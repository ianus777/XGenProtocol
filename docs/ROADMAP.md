...
│   ├── ✅ **M-RP-MEMBER-ACT** — the members panel acts: LMC opens the DM, RMC opens the menu · **✅ CLOSED 2026-08-12 at J-716** — C-bis-5 drove the verification pass; Leg C-bis v1.12 COMPLETED, runbook v1.13 COMPLETED · **Leg C CLOSED J-700 — LMC ships; the RMC context menu and Leg C-bis remain** · Phase-0 `tasks/M_RP_MEMBER_ACT_PHASE0.md` v1.11 · Leg C Phase-0 `tasks/M_RP_MEMBER_ACT_LEG_C_PHASE0.md` v1.5 COMPLETED · Leg C runbook `tasks/RUNBOOK_MEMBER_ACT_LEG_C.md` v1.2 COMPLETED · Leg C-bis `tasks/M_RP_MEMBER_ACT_LEG_C_BIS.md` v1.12 COMPLETED · Leg C-bis runbook `tasks/RUNBOOK_MEMBER_ACT_LEG_C_BIS.md` v1.13 COMPLETED · runbook `tasks/RUNBOOK_MEMBER_ACT_LEG_AB.md` v1.3 COMPLETED · `ce82ebe` `8c70d14` `132ce85` `41bf61a` `7305df2` `524d4f7` `b5d0908` `6a6c066` `e0d4d9a` `96a935f` `8601e677` `37c09d7` · `DECISIONS.md` D-143 + D-144 + D-145 · `N-169` + `N-170` + `N-171` + `N-174` + `N-175` + `N-176` + `N-177` + `N-178` + `N-179` + `N-180` + `N-181` + `N-182` · J-709 (J-708, J-707, J-706, J-680, J-681, J-682, J-683, J-685, J-686, J-687, J-688, J-689, J-690, J-691, J-692, J-699, J-700, J-702, J-703, J-704)
│   │   ↳ Owes: — **DISCHARGED BY THE COMMIT THAT CLOSES THIS NODE (J-715 ruling, and this 1417-char line is the FIRST to exercise it).** Every item resolved or re-sited, and the reasoning is RELOCATED, NOT DELETED: `OWED-1` discharged live at J-716 · `OWED-4` measured, shown unruled per `D-146`, then ruled *"correct behaviour"* by Joe · `OQ5`'s two items carried and closed in Leg C-bis's DoD · the RMC context menu → **Leg D, POSTPONED with a MEASURED reason** · Leg E's Space-never-clicked case → **Leg E** · the erased row's retention → the history-expiry milestone · `N-171` shipped as written on Joe's delegated ruling · cross-node invite discovery and clippy's four pre-existing errors remain untracked and untouched. → **J-716 · N-189 · N-190 · `tasks/M_RP_MEMBER_ACT_LEG_C_BIS.md` §7-bis and §8**
│   │   ↳ trigger: **ALL LEGS DRIVEN. C-bis-5 CLOSED THE MILESTONE at J-716** — eight checklist items green, quiescent registry `168` at a SEVEN-Space tree recorded AS THE TREE (`N-184`), **nothing of Joe's spent: no DM minted, client state `4204 B` unmoved, exact return to baseline.** **STOP — §5.5's gate could not pass as written and was RE-WORDED BEFORE IT WAS RUN (Joe, option A)** — the clamp is `skin.css`, Joe's, not landed; the overflow is now a named unskinned state with `M-RP-SKIN` as discharger. **KEY — §7's owed `D-131` annotation turned on §7 ITSELF** — the record held two entries quoting the same CSS with opposite conclusions; settled by live measurement (`N-189`): **the CSS never changed, the STRING did.** **WARNING — `M-RP-INTRO`'s trigger *"Leg C-bis lands"* FIRES WITH THIS COMMIT and it has no Phase-0** — flagged to Joe, not started. **Leg E's gate stays discharged since J-710/J-711; the DM home is next in front.**

...
**Three sub-regions identified at grep**:
...
- **Top-level orchestrators**: `process_inbound`, `run_node` — sit between WebSocket/federation transport and runtime

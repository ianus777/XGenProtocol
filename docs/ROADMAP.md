...
│   ├── 🟢 **M-RP-INTRO** — the DM welcome intro: whoever opens the conversation sends their own opening card · FILED at J-701 · **PHASE-0 LANDED J-732**, `tasks/M_RP_INTRO_PHASE0.md` v1.3 ACTIVE · `ae415db` `ca10ccb` · **ALL THREE GATES RULED 2026-08-15** · ships as the OPENING MESSAGE in message chrome, not as system chrome

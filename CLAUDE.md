...
## 🟢 PLAY — M6 (new): **bootstrap-client (A3) arc — C3 the 5 verbs + AdminContext threading SHIPPED (J-193, prime-invariant regression in place)**; **next-active = C4 (keepalive scheduler + best-effort set-info re-advertise)** → C5 close → node-policy; then M7 `--aicontrol`

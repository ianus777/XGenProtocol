...
mod tests {
    ...
    async fn setup_alice_and_space(
        ...
        let space_ev = sign_event(
            build_space_create_event(&alice_key, space_name, None, 1, &node_b.node_id, None, false),
            &alice_key,
        );
    ...
    async fn extended_skip_set_does_not_trigger_f3_deferral() {
        ...
        let space_create_from_x = sign_event(
            build_space_create_event(&peer_x_key, "x-new-space", None, 1, &peer_x_id, None, false),
            &peer_x_key,
        );

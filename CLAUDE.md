...
> Date: May 2026  
> **Status:** ACTIVE  
> **Last updated:** 2026-05-18 (D-071 promoted to DECISIONS.md — "Subsystem audits precede dependent milestones" project-management principle. Sibling to D-065 / D-070 (protocol-design principles); D-071 names the audit-precedes-design discipline that J-081 retroactively instantiated and Federation Event Propagation Phase 0 inherited. Pairs with D-069: audit phase → design phase → implementation phase, each producing a canonical artefact.)  
> Author: JozefN  

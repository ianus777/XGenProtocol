...
## 🟢 UI component-library / substrate (RP track) — M-RP2.12 ✅ CLOSED (J-417): `textfield` gains a constrained `type` prop — the string-input family (`text|search|email|url|tel|password`) folds into one component (reverses N-029 → D-096) — CDP-verified BOTH apps

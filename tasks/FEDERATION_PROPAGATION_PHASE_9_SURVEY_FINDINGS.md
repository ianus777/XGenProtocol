...
|---|---|---|---|
| `forged_sender_with_resign_message_text` | `ValidationOutcome::HeldPending { missing_identity: Some(attacker_uri), missing_predecessors: vec![] }` | F-4 step 11 unknown-sender per Phase 6 F-10 generalisation (J-087) | `DispatchOutcome::HeldPending` (unit) + PendingBuffer inspection (see Rust block below) |

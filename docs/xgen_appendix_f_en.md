...
When invoked with no subcommand and no fundamental flag, opens the Tauri desktop shell (M1+, D-056b/D-062). Pass `--service` for the equivalent of the pre-M1 "just run the binary" behaviour.

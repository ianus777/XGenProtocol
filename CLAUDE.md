...
## 🟢 PLAY — Topological-sort design-phase re-walk Step 3 (runbook v1.0 → v1.1 revision) ←── HERE (Chat Claude + Joe next session); Path B locked at event-construction layer; D-076 v1.1 in DECISIONS.md

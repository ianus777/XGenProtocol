...
## 🟢 PLAY — M6 (new): **bootstrap-client (A3) arc — C2 framed send-path SHIPPED (J-192, checkpoint #2 CLOSED)**; **next-active = C3 (the 5 verbs + PRIME-INVARIANT regression)** → C4–C5 → node-policy; then M7 `--aicontrol`

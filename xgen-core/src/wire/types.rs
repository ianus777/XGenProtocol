...
pub use xgen_common::wire::{
    ...
    StateSpaceAdmissionContent, StateSpacePacingContent,
    StateSpaceTemperatureVisibilityContent, ThreadStatus,
    TemperatureThresholds, ADMISSION_INVITE, ADMISSION_MAX_LEN, ADMISSION_OPEN,
    DEFAULT_ADMISSION,

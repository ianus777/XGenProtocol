...
//
// XGID Retrofit Pass 1 Commit 1 moved these helpers from xgen-core/src/wire/canonical.rs
// into xgen-common so the v1 flavour-wrapper convenience constructors (EventXgid::from_event,
// SpaceXgid::from_space_create, RoomXgid::from_room_create, TrustAssertionXgid::from_assertion)
// can call canonical_event_bytes from xgen-common at Commit 2. xgen-core/src/wire/canonical.rs
// is now a thin re-export shim preserving existing call sites.

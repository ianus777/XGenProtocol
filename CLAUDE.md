...
## 🟢 PLAY — M6 (new): **auth-module-registry (A2) D-071 arc CLOSED at J-189 (A2 5/5 ✅)**; **next-active = bootstrap-client (A3) arc — design phase** → then node-policy; then M7 `--aicontrol`

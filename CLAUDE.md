...
## 🟢 PLAY — M6 (new): **bootstrap-client (A3) arc — design LOCKED (J-190) + C1 data layer SHIPPED (J-191)**; **next-active = C2 (framed send-path, checkpoint #2 first)** → C3–C5 → node-policy; then M7 `--aicontrol`

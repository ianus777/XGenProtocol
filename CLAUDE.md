...
## 🟢 UI component-library / substrate (RP track) — M-RP2.8 ✅ CLOSED (J-413): `select` — fourth `core` component (di·A, single-select, atomic `<select>`), authored + skinned in one pass; first content-carrying di — CDP-verified BOTH apps

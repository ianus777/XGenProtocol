...
## 🟢 PLAY — M6 (new): **auth-module-registry (A2) D-071 arc — Commit 1 SHIPPED at J-185**; **next-active = Clair Commit 2 (`AuthModuleRecord` + `AuthModuleRegistry` store)** → C3–C5 → bootstrap-client; then M7 `--aicontrol`

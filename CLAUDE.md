...
## 🟢 PLAY — M7 `--aicontrol`: **implementation ACTIVE — reshaped to command-pipes-only (C1+C2+C4+close); checkpoint #2 resolved → events pipe DEFERRED (J-203)**; **next-active = C4 node command pipe** (checkpoint-free, symmetric to C2)

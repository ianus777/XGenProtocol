...
🛑 **B-TER's SCOPE WAS ALREADY DISCHARGED AT J-603 (2026-07-28) — THREE DAYS BEFORE THIS LEG WAS SPAWNED AT J-626. MEASURED 2026-07-31 (J-634).** `JOURNAL.md` L842 carries **`## Entry J-603 — six ROADMAP-only records recovered into the journal, and four numbers recorded as never written`**, written under **Leg C**, between stage 1 and stage 2.
- ✅ **CLASS ① — THE SIX BODIES ARE IN `JOURNAL.md` AND ARE BYTE-IDENTICAL TO THE ARCHIVE.** SHA256 compared pair by pair: `J-123` 6,670 · `J-124` 4,678 · `J-125` 6,664 · `J-131` 4,905 · `J-132` 1,064 · `J-135` 1,518 — **all six identical.** J-603 states it as *“NOT RECONSTRUCTED, NOT SUMMARISED, NOT REFLOWED — the exact bytes that stood in ROADMAP.”*
- ✅ **CLASS ② — THE FOUR ARE ALREADY RECORDED**, at `JOURNAL.md` L882 `### Cited but never written — four numbers with no body in any document`, and **explicitly recorded as never-written rather than reconstructed** because inferring them *“would be exactly the invent-a-link failure”*. 📌 **Chat independently recommended that same disposition at J-634 before finding this — the record had settled it on 2026-07-28, and a Phase-0 brief would have asked Joe to re-decide it.**
- ⚠️ **AND J-603 CARRIES A SECOND PASS THIS SCOPE STATEMENT DOES NOT MENTION:** L895 `## Second recovery pass — twelve Past entries whose record exists in no journal at all`, measured as *`Past — settled` holds 103 entries / 276,596 bytes; 91 have a journal entry LARGER than the ROADMAP copy*. **Status of that pass is UNVERIFIED.**
- 🔓 **DISPOSITION IS JOE'S AND IS NOT TAKEN HERE:** close B-ter as discharged · reduce it to `J-029` alone · or re-scope it onto the twelve. 📌 **Chat's lean: close as discharged, and verify the twelve as its own scoped check.**
...
🔓 **OPEN, JOE'S — NONE IS A GATE:** ① **sequencing: what runs next** (**Leg B-ter's disposition — close as discharged · reduce to `J-029` · or re-scope onto J-603's twelve** · **verify J-603's second recovery pass** · **Leg F sweep** · **Leg G still blocked**) ② **the back-fill milestone's name** — belongs to Leg F's sweep ③ 📌 **`D-134` §2's justification clause** — recommended as an **annotation**, not an amendment ④ 🔓 **`D-135` §5a — DRAFTED (J-632), delegated and reversible, AWAITING CONFIRM / AMEND / DISCARD** ⑤ 🔓 **Leg G's ordering constraint — re-point it from the six to the twelve.** ✅ **CLOSED: `D-135` locked (J-631) · Leg E P3 executed and Leg E closed (J-633).**

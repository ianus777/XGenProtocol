...
mod tests {
    ...
    fn simple_space_state(owner_id: &str, owner_role: Role, home_node: &str) -> SpaceState {
        ...
        SpaceState {
            ...
            admission: crate::wire::types::DEFAULT_ADMISSION.to_string(),
        }
    }
    ...
    fn loser_event_stays_in_dag() {
        ...
        let space_ev = sign_event(build_space_create_event(&alice_key, "Test", None, 1, "node1", None, false), &alice_key);

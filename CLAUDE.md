...
## 🟢 PLAY — M7 `--aicontrol`: **Phase-0 audit DONE (J-198, doc-only) — canonical M7 doc drift-checked vs the shipped surface; §12 triaged**; **next-active = design phase** (lock the verb-name model + envelope first) — Clair stood down

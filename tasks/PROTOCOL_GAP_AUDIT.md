...
|----|-----|---------|-----|--------|--------------|--------|
| PG-02 | S1 | DESIGN-LOCKED / impl-deferred (D-088, PG-05-gated) | Uniform tier-graded deletion/erasure Event across federation (GDPR) | ch1 L879–883 | Design erasure event + federated propagate/confirm/audit (large; arc I) | ⬜ OPEN |
...
**Open: 2 / 13 · Done: 10 · NO-GAP-reclassified: 1** (done: PG-01/06/07 Arc A, PG-09 Arc B, PG-12/13 Arc D, PG-03/08 Arc E, PG-04 Arc G, PG-11 Arc F; PG-10 reclassified NO-GAP at Arc D close). Open: PG-02, PG-05. Register 13 (PG-13 spun off from PG-07's verify). Arc letters map to §4 candidate-milestone groupings.

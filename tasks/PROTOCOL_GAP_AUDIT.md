...
**Open: 4 / 13 · Done: 8 · NO-GAP-reclassified: 1** (done: PG-01/06/07 Arc A, PG-09 Arc B, PG-12/13 Arc D, PG-03/08 Arc E; PG-10 reclassified NO-GAP at Arc D close). Open: PG-02, PG-04, PG-05, PG-11. Register 13 (PG-13 spun off from PG-07's verify). Arc letters map to §4 candidate-milestone groupings.

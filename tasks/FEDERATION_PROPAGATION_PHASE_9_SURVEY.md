...
> Version: 2.0  
> Date: May 2026  
> **Last updated**: 2026-05-19 (v2.0 — adversarial rewrite: ten items instead of eight; per-scenario stress dimensions; compound scenarios; failure-mode catalogue + observability audit; flake-handling recommendation walked to "fix both as precondition"; priority restated as "working functions, not done-mark on roadmap")  
> Language: English  
> Author: JozefN  

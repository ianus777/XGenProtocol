...
**F. Migration subsystem** — PG-11; wire types exist, handlers deferred. Self-contained.
...
**I. GDPR erasure / right-to-be-forgotten** — PG-02 (S1). Large design arc (DAG-immutability vs Art.17, federated delete-confirm, replicated-identity erasure). Gates Tier-2+ deployments; not Tier-1-multiparty-blocking.
...
**Open: 3 / 13 · Done: 9 · NO-GAP-reclassified: 1** (done: PG-01/06/07 Arc A, PG-09 Arc B, PG-12/13 Arc D, PG-03/08 Arc E, PG-04 Arc G; PG-10 reclassified NO-GAP at Arc D close). Open: PG-02, PG-05, PG-11. Register 13 (PG-13 spun off from PG-07's verify). Arc letters map to §4 candidate-milestone groupings.

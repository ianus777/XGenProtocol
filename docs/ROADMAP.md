...
│   │   └── 🟡 **Leg E records + close**
│   │       ↳ trigger: Leg D lands
│   ├── 🟢 **M-RP-MEMBER-ACT** — the members panel acts: LMC opens the DM, RMC opens the menu · Phase-0 `tasks/M_RP_MEMBER_ACT_PHASE0.md` v1.10 · runbook `tasks/RUNBOOK_MEMBER_ACT_LEG_AB.md` v1.1 · `DECISIONS.md` D-143 + D-144 + D-145 · J-686 (J-680, J-681, J-682, J-683, J-685)
...
│   │   ↳ trigger: Joe locks the Leg A/B runbook — L2's loader-unification step has had no outside read
